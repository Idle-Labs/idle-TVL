...
const COMP_abi = require('./abis/COMP.js').abi;
const ERC20_abi = require('./abis/ERC20.js').abi;
const IdleTokenV4_abi = require('./abis/IdleTokenV4.js').abi;
const IdleTokenV3_abi = require('./abis/IdleTokenV3.js').abi;
const uniswapRouter_abi = require('./abis/uniswapRouter.js').abi;
const UniswapExchangeInterface = require('./abis/UniswapExchangeInterface.js').abi;

async function main(){
	const env = process.env;

  if (!env.INFURA_KEY || !env.INFURA_KEY.length){
    console.log('Please insert your infura key in the .env file.');
    return false;
  }
	...
	// Init web3
	const web3Host = `https://mainnet.infura.io/v3/${env.INFURA_KEY}`;
	...
	const uniswapRouter = new web3.eth.Contract(uniswapRouter_abi, uniswapRouterAddr);
	...
	console.log('Idle TVL: ',totalTVL.toString());
